"""
Telegram Bot - SWING + SAATLİK Kart
DÜZELTME: Tavan adayı tespiti sıkılaştırıldı
"""
...
def is_tavan_adayi(signal):
    """
    SIKILAŞTIRILMIŞ TAVAN ADAYI TESPİTİ
    SADECE gerçek tavan adayları:
    - "TAVAN ADAYI" kelimesi geçenler (+%5-8 yükseliş + hacim)
    - "GÜN İÇİ PATLAMA" kelimesi geçenler (intraday range)
    
    YÜKSELİŞ, POZİTİF GÜN gibi genel kelimeler TAVAN ADAYI DEĞİL!
    """
    if not signal or not signal.get('reasons'): return False
    for r in signal['reasons']:
        title = r.get('title', '').upper()
        # SADECE bu spesifik başlıklar TAVAN ADAYI
...
def format_hourly_signal(signal, signal_index=1):
    ...
    msg += "━━━━━━━━━━━━━━━━━━━━━━━\n🎯 <b>GÜN İÇİ PLAN</b>\n━━━━━━━━━━━━━━━━━━━━━━━\n\n"
    msg += f"📥 <b>GİRİŞ:</b> {entry:.2f} TL\n🎯 <b>HEDEF:</b> {target:.2f} TL (<b>+{target_pct}%</b>)\n🛑 <b>STOP:</b> {stop:.2f} TL (<b>-{stop_pct}%</b>)\n\n"
